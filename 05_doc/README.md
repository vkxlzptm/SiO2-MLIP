...
> 수치를 인용할 일이 있으면 `SOURCES.md`에서 확인 수준을 먼저 볼 것.
...
| **`PPT_BRIEF.md`** | **PPT 제작 인수인계 (제작 완료 2026-08-18).** 코닝 송부 맥락, 슬라이드 구성, 표기 규칙, 반드시 피할 함정 6개, 슬라이드 작성 규칙 §10 |
| **`SOURCES.md`** | **실험값·문헌값 출처.** 각 인용의 확인 수준(원문 확인 / 2차 인용 / 결론 없음)과 덱 참고문헌 번호표 |
