...
plt.rcParams.update({
    ...
    "legend.fontsize": 9, "legend.handlelength": 1.4,
...
fig, ax = plt.subplots(2, 1, figsize=(3.7, 5.1))
...
a.set_yscale("log"); a.set_ylim(2e2, 6e6)
...
a.text(0.035, 0.90, "(a)", transform=a.transAxes, fontsize=11.5, fontweight="bold")
...
a.plot([1.66], [2e5*1.9], "o", ms=7, mfc="w", mec="tab:red", mew=1.6, clip_on=False)
a.text(1.84, 2e5*1.9, r"7net-Nano-4.5 @ $\rho$2.20", fontsize=8.5, va="center")
a.text(1.67, 7e4*1, r"bars: @ $\rho$2.607" + "\n" + r"(cutoff sweep)",
...
b.text(4.1, 5.6, "6 physical\ncores", fontsize=8, c="0.35", va="top", ha="center")
...
b.legend(bbox_to_anchor = (1, 0.56), loc="center right", framealpha=0.9)
b.text(0.035, 0.90, "(b)", transform=b.transAxes, fontsize=11.5, fontweight="bold")
...
fig.suptitle("2160-atom a-SiO$_2$,  i5-11600K (6c12t), no GPU", fontsize=10.5, y=1, x=0.53)
fig.tight_layout(rect=[0, 0, 1, 1.03])
fig.savefig(FIG / "fig_speed_vert.png", dpi=300)
print(f"-> {FIG}/fig_speed_vert.png\n")
